...
class SubscriptionPurchaseService:
    def __init__(
        ...
        self.gateway_selection_service = SubscriptionPurchaseGatewaySelectionService(
    ...
    async def quote(
        ...
        *,
        ...
        gateway, gateway_type = await self.gateway_selection_service.resolve_purchase_gateway(
            request=request
        )
        payment_asset = self.gateway_selection_service.resolve_payment_asset(
            request=request,
