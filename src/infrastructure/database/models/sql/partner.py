...
from sqlalchemy import JSON, BigInteger, Boolean, Enum, ForeignKey, Integer, Numeric, String
...
class PartnerWithdrawal(BaseSql, TimestampMixin):
    ...
    requested_amount: Mapped[Optional[Decimal]] = mapped_column(Numeric(24, 8), nullable=True)
    requested_currency: Mapped[Optional[Currency]] = mapped_column(
        Enum(
            Currency,
            name="currency",
            create_constraint=True,
    ...
    quote_rate: Mapped[Optional[Decimal]] = mapped_column(Numeric(24, 8), nullable=True)
    quote_source: Mapped[Optional[str]] = mapped_column(String, nullable=True)
