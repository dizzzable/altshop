...
class Pal24GatewaySettingsDto(GatewaySettingsDto):
    ...
    type: PaymentGatewayType = PaymentGatewayType.PAL24
    api_key: Optional[SecretStr] = None
    shop_id: Optional[str] = None
...
class WataGatewaySettingsDto(GatewaySettingsDto):
    ...
    type: PaymentGatewayType = PaymentGatewayType.WATA
...
class PlategaGatewaySettingsDto(GatewaySettingsDto):
    ...
    type: PaymentGatewayType = PaymentGatewayType.PLATEGA
    merchant_id: Optional[str] = None
    secret: Optional[SecretStr] = None
    payment_method: int = 1  # Default payment method ID
