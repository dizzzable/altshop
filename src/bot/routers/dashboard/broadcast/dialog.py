...
send = Window(
    ...
    Row(
        Button(
            I18nFormat("btn-broadcast-promocode-toggle", enabled=F["promocode_enabled"]),
            id="promocode_toggle",
            on_click=on_promocode_toggle,
        ),
        SwitchTo(
            I18nFormat("btn-broadcast-promocode-code", code=F["promocode_code"]),
            id="promocode_code",
            state=DashboardBroadcast.PROMOCODE,
        ),
    ),
    Row(
        Start(
...
promocode = Window(
    Banner(BannerName.DASHBOARD),
    I18nFormat("msg-broadcast-promocode"),
    Row(
        Button(
            I18nFormat("btn-broadcast-promocode-clear"),
            id="promocode_clear",
            on_click=on_promocode_clear,
        ),
    ),
    Row(
        SwitchTo(
