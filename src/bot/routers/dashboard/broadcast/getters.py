...
async def send_getter(
    ...
    **kwargs: Any,
    ...
    promocode_code = str(dialog_manager.dialog_data.get("promocode_code") or "").strip()
    promocode_enabled = bool(dialog_manager.dialog_data.get("use_promocode_button"))

    return {
        "audience_type": audience,
        "audience_count": audience_count,
        "promocode_code": promocode_code or "-",
        "promocode_enabled": 1 if promocode_enabled else 0,
    }
    ...
    formatted_broadcasts = [
        {
            ...
            "created_at": broadcast.created_at.strftime(DATETIME_FORMAT),
        }
