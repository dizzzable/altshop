...
configurator = Window(
    ...
    Row(
        SwitchTo(
            text=I18nFormat("btn-plan-subscription-count"),
            id="subscription_count",
            state=RemnashopPlans.SUBSCRIPTION_COUNT,
        ),
    ),
    Row(
        SwitchTo(
...
plan_subscription_count = Window(
    Banner(BannerName.DASHBOARD),
    I18nFormat("msg-plan-subscription-count"),
    Row(
        SwitchTo(
            text=I18nFormat("btn-back"),
            id="back",
    ...
    MessageInput(func=on_subscription_count_input),
    IgnoreUpdate(),
    state=RemnashopPlans.SUBSCRIPTION_COUNT,
)
