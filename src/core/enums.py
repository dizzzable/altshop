...
class ReferralInviteSource(UpperStrEnum):
    BOT = auto()
    WEB = auto()
    UNKNOWN = auto()
...
class PurchaseChannel(UpperStrEnum):
    WEB = auto()
    TELEGRAM = auto()


class PaymentSource(UpperStrEnum):
    EXTERNAL = auto()
    PARTNER_BALANCE = auto()
...
class DiscountSource(UpperStrEnum):
    NONE = auto()
    PERSONAL = auto()
    PURCHASE = auto()
...
class UserNotificationType(UpperStrEnum):  # == UserNotificationDto
    ...
    REFERRAL_QUALIFIED = auto()
    PARTNER_REFERRAL_REGISTERED = auto()
    PARTNER_EARNING = auto()
    PARTNER_WITHDRAWAL_REQUEST_CREATED = auto()
    PARTNER_WITHDRAWAL_UNDER_REVIEW = auto()
    PARTNER_WITHDRAWAL_COMPLETED = auto()
    PARTNER_WITHDRAWAL_REJECTED = auto()
...
class CryptoAsset(UpperStrEnum):
    USDT = auto()
    TON = auto()
    BTC = auto()
    ETH = auto()
