...
MAX_SUBSCRIPTIONS_PER_USER: Final[int] = 5

# Number of days after subscription expiration before user is deleted from panel
EXPIRED_SUBSCRIPTION_CLEANUP_DAYS: Final[int] = 3
