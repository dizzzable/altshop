...
msg-backup-result-created-at = 🗓 Created: { $value }
msg-backup-result-tables = 📊 Tables: { $count }
msg-backup-result-records = 📈 Records: { $count }
msg-backup-result-db-summary = 🗄 Database: { $tables } tables / { $records } records
msg-backup-result-assets-summary = 🗂 Assets: { $count } files
...
msg-backup-caption-created-title = ✅ Backup created
msg-backup-caption-scope = 📦 { $scope }
msg-backup-caption-size = 💾 { $value }
msg-backup-caption-created-at = 🗓 { $value }
msg-backup-caption-db-summary = 🗄 { $tables } tables / { $records } records
msg-backup-caption-assets-summary = 🗂 Assets: { $count } files
msg-backup-caption-degraded = ⚠️ Degraded archive
