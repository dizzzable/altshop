...
ntf-event-access-policy =
    ...
    <b>🔅 Event: Invite access policy triggered!</b>
...
ntf-bot-menu-mode-enabled = <i>✅ Mini App-first menu mode enabled.</i>
ntf-bot-menu-mode-disabled = <i>✅ Mini App-first menu mode disabled.</i>
ntf-bot-menu-mode-missing-url = <i>⚠️ Configure a Mini App URL first or keep BOT_MINI_APP as fallback before enabling this mode.</i>
ntf-bot-menu-url-saved = <i>✅ Mini App URL saved.</i>
ntf-bot-menu-url-cleared = <i>✅ Stored Mini App URL cleared.</i>
ntf-bot-menu-url-cleared-disabled = <i>✅ Stored Mini App URL cleared. Mini App-first mode was disabled because there is no effective Mini App URL anymore.</i>
ntf-bot-menu-invalid-url = <i>❌ Invalid URL. Send an absolute https:// link.</i>
ntf-bot-menu-button-created = <i>✅ Custom button created. Open it to finish configuration.</i>
ntf-bot-menu-button-updated = <i>✅ Custom button updated.</i>
ntf-bot-menu-button-deleted = <i>✅ Custom button deleted.</i>
