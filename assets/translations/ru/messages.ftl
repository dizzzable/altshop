...
msg-user-subscription-info =
    ...
    *[0] Нет
    ...
    { hdr-subscription }
    <blockquote>
    • <b>Профиль панели</b>: { $profile_name ->
...
msg-backup-result-created-at = 🗓 Дата: { $value }
msg-backup-result-tables = 📊 Таблиц: { $count }
msg-backup-result-records = 📈 Записей: { $count }
msg-backup-result-db-summary = 🗄 База данных: { $tables } таблиц / { $records } записей
msg-backup-result-assets-summary = 🗂 Assets: { $count } файлов
...
msg-backup-result-archive-issues = ⚠️ Обнаружены проблемы архива: { $count }
msg-backup-result-remnawave-users = 🔄 Пользователей синхронизировано из Remnawave: { $count }
msg-backup-result-remnawave-subscriptions = 📡 Подписок восстановлено из Remnawave: { $count }
msg-backup-result-unrecoverable-subscriptions = ⚠️ Невосстановимых пользовательских подписок: { $count }
msg-backup-result-remnawave-sync-errors = ⚠️ Ошибок синхронизации Remnawave: { $count }
msg-backup-result-degraded = ⚠️ Бэкап помечен как деградированный
msg-backup-caption-created-title = ✅ Бэкап создан
msg-backup-caption-scope = 📦 { $scope }
msg-backup-caption-size = 💾 { $value }
msg-backup-caption-created-at = 🗓 { $value }
msg-backup-caption-db-summary = 🗄 БД: { $tables } таблиц / { $records } записей
msg-backup-caption-assets-summary = 🗂 Assets: { $count } файлов
msg-backup-caption-degraded = ⚠️ Деградированный архив
