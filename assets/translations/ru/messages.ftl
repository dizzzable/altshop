...
msg-user-assign-plan =
    ...
    Выберите активный план. Он будет применен к текущей подписке пользователя.
...
msg-plan-archived-renew-mode =
    ...
    Выберите, можно ли продлевать этот архивный тариф как есть
    или при продлении он должен заменяться на один из доступных тарифов.

msg-plan-replacement-plans =
    <b>🔄 Тарифы для замены при продлении</b>

    Отметьте тарифы, которые можно предложить пользователю,
    если архивный тариф больше нельзя продлевать напрямую.

msg-plan-upgrade-plans =
    <b>⬆️ Тарифы для улучшения</b>

    Отметьте тарифы, на которые разрешено улучшение
    из текущего тарифа.
